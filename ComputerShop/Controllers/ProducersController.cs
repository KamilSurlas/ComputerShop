...
namespace ComputerShop.Controllers
{
    public class ProducersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IsPromoted")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IsPromoted")] Producer producer)
        {
            if (id != producer.Id)
            {
                return NotFound();
